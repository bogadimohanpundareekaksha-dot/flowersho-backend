    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http, JwtAuthenticationFilter jwtAuthenticationFilter) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/", "/index.html", "/assets/**", "/login", "/dashboard", "/all-customers", "/customer", "/customer/**", "/api/auth/**", "/api/dashboard/**", "/api/customers/**", "/api/bills/**", "/api/payments/**", "/api/uploads/**", "/swagger-ui/**", "/v3/api-docs/**").permitAll()
